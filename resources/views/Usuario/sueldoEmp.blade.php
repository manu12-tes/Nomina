<html>
    ...
    <br>
        ...
        <h6 class=subtitle>Reporte de depositos</h6>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @foreach($sueldoEmp as $x)
        <tr>
            
            <td>{{$x->curp }}</td>
            <td>{{$x->sueldoDiario }}</td>
            <td>{{$x->periodoPago }}</td>
        ...
        <div align = "center">
            <a href="{{url('pdf')}}"><button class="button is-link" type="button">Generar PDF</button></a>
        </div>
